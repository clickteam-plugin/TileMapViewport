...
short WINAPI DLLExport GetRunObjectInfos(mv _far *mV, fpKpxRunInfos infoPtr)
{
	...
	infoPtr->editFlags  =  OEFLAG_VALUES|OEFLAG_SPRITES|OEFLAG_MOVEMENTS|OEFLAG_BACKSAVE|OEFLAG_SCROLLINGINDEPENDANT|OEFLAG_RUNBEFOREFADEIN|OEFLAG_NEVERKILL|OEFLAG_NEVERSLEEP ;
	infoPtr->editPrefs =  OEPREFS_BACKSAVE|OEPREFS_SCROLLINGINDEPENDANT|OEPREFS_LOADONCALL|OEPREFS_KILL|OEPREFS_INKEFFECTS ;
