...
public:
  ...
  bool FilterObjects(LPRDATA rdPtr, short Oi, bool negate,
...
private:
  ...
  bool FilterQualifierObjects(LPRDATA rdPtr, short Oi, bool negate,
                              bool (*filterFunction)(LPRDATA, LPRO));
  bool FilterNonQualifierObjects(LPRDATA rdPtr, short Oi, bool negate,
                                 bool (*filterFunction)(LPRDATA, LPRO));
